    ...
    <>
      ...
      <div id="printable-content" className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
        <div className="print-header">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6749582d8_LogoGeneral_110x110_P.png" alt="Atera Logo" className="h-8" />
        ...
        <div className="print-title">
          <div className={`inline-flex items-center gap-3 mb-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
            <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6749582d8_LogoGeneral_110x110_P.png" alt="Atera Logo" className="h-16 w-16" />
